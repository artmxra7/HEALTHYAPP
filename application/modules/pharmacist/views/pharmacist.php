                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                               ...
                                               // $('#editPharmacistForm').find('[name="nik"]').val(response.pharmacist.nik).end()
                                               // $('#editPharmacistForm').find('[name="gender"]').val(response.pharmacist.gender).end()
                                                ...
                                                //$('#editPharmacistForm').find('[name="phone"]').val(response.pharmacist.phone).end()
                                                 //$('#editPharmacistForm').find('[name="salary"]').val(response.pharmacist.salary).end()
                                            });
                                        });
                                    });
</script>
