            ...
            <aside class="profile-nav">
                <section class="">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>  <?php echo lang('patient_id'); ?> <span class="label pull-right r-activity"><?php echo $patient->id_rm; ?></span></li>
                        <li>  <?php echo lang('gender'); ?><span class="label pull-right r-activity"><?php echo $patient->sex; ?></span></li>
                        <li>  Height<span class="label pull-right r-activity"><?php echo $patient->t_badan; ?> CM</span></li>
                        <li> Weight<span class="label pull-right r-activity"><?php echo $patient->b_badan; ?> KG</span></li>
