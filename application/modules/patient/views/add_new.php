                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="patient/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="id_rm" id="exampleInputEmail1" value='<?php
                                            if (!empty($setval)) {
                                                echo set_value('id_rm');
                                            }
                                            if (!empty($patient->id_rm)) {
                                                echo $patient->id_rm;
                                            }
                                            ?>' placeholder="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="t_badan" id="exampleInputEmail1" value='<?php
                                            if (!empty($setval)) {
                                                echo set_value('t_badan');
                                            }
                                            if (!empty($patient->t_badan)) {
                                                echo $patient->t_badan;
                                            }
                                            ?>' placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Weight</label>
                                            <input type="text" class="form-control" name="b_badan" id="exampleInputEmail1" value='<?php
                                            if (!empty($setval)) {
                                                echo set_value('b_badan');
                                            }
                                            if (!empty($patient->b_badan)) {
                                                echo $patient->b_badan;
                                            }
                                            ?>' placeholder="">
                                        </div>
