            ...
            <div class="modal-body row">
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">No Medical Record</label>
                        <input type="text" class="form-control" name="id_rm" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="t_badan" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Weight</label>
                        <input type="text" class="form-control" name="b_badan" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group last col-md-4">
                        <div class="">
                            ...
                            <div class="col-md-12">
                                <label for="exampleInputEmail1">No MR: <span class="id_rmClass"></span></label>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Height (KG)</label>
                        <div class="t_badanClass"></div>
                    </div>
                     <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Weight (CM)</label>
                        <div class="b_badanClass"></div>
                    </div>
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            $('#editPatientForm').find('[name="id_rm"]').val(response.patient.id_rm).end()
            $('#editPatientForm').find('[name="name"]').val(response.patient.name).end()
            $('#editPatientForm').find('[name="t_badan"]').val(response.patient.t_badan).end()
            $('#editPatientForm').find('[name="b_badan"]').val(response.patient.b_badan).end()
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".inffo", function () {
        ...
        $('.id_rmClass').html("").end()
        $('.nameClass').html("").end()
        $('.t_badanClass').html("").end()
        $('.b_badanClass').html("").end()
        $('.emailClass').html("").end()
        ...
        $.ajax({
            ...
            $('.id_rmClass').append(response.patient.id_rm).end()
            $('.nameClass').append(response.patient.name).end()
            $('.t_badanClass').append(response.patient.t_badan).end()
            $('.b_badanClass').append(response.patient.b_badan).end()
