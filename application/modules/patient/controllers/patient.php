...
class Patient extends MX_Controller {
    ...
    public function addNew() {
        ...
        // Validating id_rmField
        $this->form_validation->set_rules('id_rm', 'Id_rm', 'trim|required|min_length[2]|max_length[100]|xss_clean');
        // Validating Name Field
        $this->form_validation->set_rules('name', 'Name', 'trim|required|min_length[2]|max_length[100]|xss_clean');
        // Validating tinggi badan Field
        $this->form_validation->set_rules('t_badan', 'T_badan', 'trim|required|min_length[2]|max_length[100]|xss_clean');
        // Validating Berat badan Field
        $this->form_validation->set_rules('b_badan', 'B_badan', 'trim|required|min_length[2]|max_length[100]|xss_clean');
...
// Validating Deposited Amount Field
    ...
    function getPatientPayments() {
        ...
        foreach ($data['patients'] as $patient) {
            ...
            $options4 = '<a class="btn btn-xs green" title="' . lang('payment') . ' ' . lang('history') . '" style="color: #fff;" href="finance/patientPaymentHistory?patient=' . $patient->id . '"><i class="fa fa-money"></i> ' . lang('payment_history') . '</a>';
