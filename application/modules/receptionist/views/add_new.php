                                    ...
                                    <form role="form" action="receptionist/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <!--- <div class="form-group">
                                            ...
                                            if (!empty($receptionist->nik)) {
                                                echo $receptionist->nik;
                                            }
                                            ?>' placeholder="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control m-bot15" name="gender" value=''>
                                                ...
                                                if (!empty($receptionist->sex)) {
                                                    if ($receptionist->sex == 'Male') {
                                                        echo 'selected';
                                                    }
                                                }
                                                ?> > Male </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            if (!empty($receptionist->salary)) {
                                                echo $receptionist->salary;
                                            }
                                            ?>' placeholder="">
                                        </div> -->
                                        <div class="form-group">
