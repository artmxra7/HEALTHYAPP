                ...
                <form role="form" class="clearfix" action="receptionist/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control m-bot15" name="gender" value=''>
                            ...
                            if (!empty($receptionist->gender)) {
                                if ($receptionist->gender == 'Male') {
                                    echo 'selected';
                                }
                            }
                            ?> > Male </option>
                                        ...
                                        $(document).ready(function () {
                                            $(".editbutton").click(function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    //$('#editReceptionistForm').find('[name="nik"]').val(response.receptionist.nik).end()
                                                    //$('#editReceptionistForm').find('[name="gender"]').val(response.receptionist.gender).end()
                                                    ...
                                                    //$('#editReceptionistForm').find('[name="salary"]').val(response.receptionist.salary).end()
                                                });
                                            });
                                        });
</script>
