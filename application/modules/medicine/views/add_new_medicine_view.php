            ...
            <div class="row">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <select class="form-control m-bot15" name="type_name" value=''>
                            <?php foreach ($typemedicine as $type_name) { ?>
                                <option value="<?php echo $type_name->type_name; ?>" <?php
                                if (!empty($type_name->type_name)) {
                                    if ($type_name->type_name== $medicine->type_name) {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo $type_name->type_name; ?> </option>
                                    <?php } ?> 
                        </select>
                    </div>
