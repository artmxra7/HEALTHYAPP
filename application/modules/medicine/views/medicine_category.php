                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($categories as $category) { ?>
                            <tr class="">
                                ...
                                <td> <?php echo $category->margin; ?> %</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="medicine/addNewCategory" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"> <?php echo lang('margin'); ?></label>
                        <input type="text" class="form-control" name="margin" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12">
                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                $('#editCategoryForm').find('[name="margin"]').val(response.medicinecategory.margin).end()
