                                        ...
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                $('#editNurseForm').find('[name="name"]').val(response.nurse.name).end()
                                                 //$('#editNurseForm').find('[name="nik"]').val(response.nurse.nik).end()
                                                  //$('#editNurseForm').find('[name="gander"]').val(response.nurse.gander).end()
                                                ...
                                                //$('#editNurseForm').find('[name="phone"]').val(response.nurse.phone).end()
                                                 //$('#editNurseForm').find('[name="salary"]').val(response.nurse.salary).end()
                                                $('#myModal2').modal('show');
                                            });
