                                ...
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    ...
                                    <span class="badge bg-warning">
                                        ...
                                        $this->db->select('COUNT(*) AS total')
                                            ->where('STR_TO_DATE(e_date, "%d-%m-%Y") < "' . $limitDate . '"');
                                        $medicine_expired_number = $this->db->get('medicine')->row_array();
                                        echo $medicine_expired_number['total'];
                                        ?>
                                    </span>
                                </a>
                                <ul class="dropdown-menu extended notification">
                                    ...
                                    <li>
                                        <p class="yellow"><?php
                                                            echo $medicine_expired_number['total'] . ' ';
                                                            echo lang('medicine_expired');
                                                            ?> </p>
                                    </li>
                                    <li>
                                        <a href="medicine/medicineExpired">
                                            <p class="green"><?php echo lang('see_your_medicine_expired'); ?></p>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li id="header_notification_bar" class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    ...
                                    <span class="badge bg-warning">
                                        <?php
                                        $this->db->select('COUNT(*) AS total')
                                            ->where('amount_received < gross_total')
                                            ->where('status', 'unpaid');
                                        $credit_report_number = $this->db->get('payment')->row_array();
                                        echo $credit_report_number['total'];
                                        ?>
                                    </span>
                                </a>
                                <ul class="dropdown-menu extended notification">
                                    ...
                                    <li>
                                        <p class="yellow"><?php
                                                            echo $credit_report_number['total'] . ' Credit Report';
                                                            ?> </p>
                                    </li>
                                    <li>
                                        <a href="finance/creditReport">
                                            <p class="green">See All Credit Report</p>
                                        </a>
                                    </li>
                                </ul>
                            </li>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php } ?>
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        <?php if (in_array('asset', $this->modules)) { ?>
                            <li>
                                <a href="asset">
                                    <i class="fa fa-sitemap"></i>
                                    <span><?php echo lang('list_asset'); ?></span>
                                </a>
                            </li>
                        <?php } ?>
                    <?php } ?>
                    ...
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <?php } ?>
                                <?php if (in_array('employe', $this->modules)) { ?>
                                    <li><a href="employe"><i class="fa fa-user"></i><?php echo lang('employe'); ?></a></li>
                                <?php } ?>
                        ...
                        <?php if (in_array('finance', $this->modules)) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="finance/creditReport"><i class="fa fa-folder"></i>Credit Report </a></li>
                                </ul>
                            </li>
                        <?php } ?>
                    <?php } ?>
                        ...
                        <?php if (in_array('medicine', $this->modules)) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="medicine/medicineType"><i class="fa fa-edit"></i>Type</a></li>
                                    <li><a href="medicine/addTypeView"><i class="fa fa-plus-circle"></i>Add Type</a></li>
                                    <li><a href="medicine/medicineStockAlert"><i class="fa fa-plus-circle"></i><?php echo lang('medicine_stock_alert'); ?></a></li>
                                    <li><a href="medicine/medicineExpired"><i class="fa fa-plus-circle"></i><?php echo lang('medicine_expired'); ?></a></li>
