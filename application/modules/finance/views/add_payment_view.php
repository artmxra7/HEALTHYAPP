                                        ...
                                        <div class="col-md-5 row">
                                            ...
                                            <div class="col-md-12 payment">
                                                <div class="form-group last">
                                                    ...
                                                    <select name="medicine_name[]" id="" class="multi-select" multiple="" id="my_multi_select3" >
                                                        <?php foreach ($medicines as $medicine) { ?>
                                                            <option class="ooppttiioonn" data-id="<?php echo $medicine->s_price; ?>" data-idd="<?php echo $medicine->id; ?>" data-cat_name="<?php echo $medicine->name; ?>" value="<?php echo $medicine->name; ?>"
                                                                    ...
                                                                    if (!empty($payment->medicine_name)) {
                                                                        ...
                                                                        foreach ($medicine_name1 as $medicine_name2) {
                                                                            ...
                                                                            if ($medicine_name3[0] == $medicine->id) {
                                                                                echo 'data-qtity=' . $medicine_name3[3];
                                                                            }
                                                                        }
                                                                    }
                                                                    ?>
        ...
        $.each($('select.multi-select option:selected'), function () {
            ...
            if ($('#idinput-' + idd).length)
            {
                ...
                var input2 = $('<input>').attr({
                    ...
                    class: "remove",
                    id: 'idinput-' + idd,
                    name: selectName === 'category_name[]' ? 'quantity_item[]' : 'quantity_medicine[]',
                    value: '1',
                ...
                $('<input>').attr({
                    ...
                    name: selectName === 'category_name[]' ? 'category_id[]' : 'medicine_id[]',
                    value: idd,
                }).appendTo('#editPaymentForm .qfloww');
            }
