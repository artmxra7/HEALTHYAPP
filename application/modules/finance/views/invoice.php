    ...
    <section class="wrapper site-min-height">
        ...
        <section class="col-md-6">
            <div class="panel panel-primary" id="invoice">
                ...
                <div class="panel-body" style="font-size: 10px; text-align: center;">
                            ...
                            <div class="col-md-12 pull-left row" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details">
                                    <p>
                                        ...
                                        <span style="text-transform: uppercase;"> :
                                            <?php echo $this->ion_auth->user($payment->user)->row()->username; ?>
                                        </span>
                                    </p>
                                </div>
                            </div>
                                ...
                                foreach ($category_name1 as $category_name2) {
                                    ...
                                    if ($category_name3[3] > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td class=""><?php echo $category_name3[1] * $category_name3[3]; ?> </td>
                                        </tr>
                                        <?php
                                    }
                                }
                            }
                            if (!empty($payment->medicine_name)) {
                                $medicine_name = $payment->medicine_name;
                                $medicine_name1 = explode(',', $medicine_name);
                                foreach ($medicine_name1 as $medicine_name2) {
                                    $i = $i + 1;
                                    $medicine_name3 = explode('*', $medicine_name2);
                                    if ($medicine_name3[3] > 0) {
                                        ?>

                                        <tr>
                                            <td><?php echo $this->finance_model->getPaymentMedicineById($medicine_name3[0])->name; ?> </td>
                                            <td class=""><?php echo $medicine_name3[1]; ?> </td>
                                            <td class=""> <?php echo $medicine_name3[3]; ?> </td>
                                            <td class=""><?php echo $medicine_name3[1] * $medicine_name3[3]; ?> </td>
                                        </tr>
                                        <?php
                                    }
                                }
                    ...
                    <div class="">
                        <div class="col-lg-6 invoice-block pull-right " style="font-size: 15px ">
                ...
                <dev class="col-md-12" style="text-align: center;" >
                	<p>--TERIMA KASIH--</p>
